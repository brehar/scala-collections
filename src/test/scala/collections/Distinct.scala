...
object Distinct {
  ...
  object Two {
    implicit def arbitrary[T: Arbitrary]: Arbitrary[Two[T]] = Arbitrary(gen)
  ...
  object Three {
    implicit def arbitrary[T: Arbitrary]: Arbitrary[Three[T]] = Arbitrary(gen)
  ...
  object Four {
    implicit def arbitrary[T: Arbitrary]: Arbitrary[Four[T]] = Arbitrary(gen)
